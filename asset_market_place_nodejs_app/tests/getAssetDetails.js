...
/**
 * Test for /getAssetDetails
 */
Test('/getAssetDetails', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getGetAssetDetails get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/getAssetDetails']['get']['responses']['200']['schema']);
